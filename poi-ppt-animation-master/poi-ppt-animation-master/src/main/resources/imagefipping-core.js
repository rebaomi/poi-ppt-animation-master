...
!function (t) {
	...
	function d() {
		...
		C += ", " + Tr.s("rotated") + " " + Util.signedNumber(t.settings.rotateAngleDeg) + "бу",
		C += ", " + Tr.s("straightened") + " " + Util.signedNumber(Util.roundTo(t.settings.straightenAngleDeg, 1)) + "бу",
	...
	function De(e, o) {
		...
		Css.CropApp.StraightenSpinner.display.$().text(t.settings.straightenAngleDeg.toFixed(1) + "бу"),
		Css.CropApp.RotateSpinner.display.$().text(t.settings.rotateAngleDeg + "бу"),
